...
* [Check to see if a File is Empty](https://github.com/DataBaeDev/Python-Odds-and-Ends/blob/main/Check_to_See_if_A_File_is_Empty.ipynb) - Check to see if a file is empty.
...
* [Date Range DataFrame](https://github.com/DataBaeDev/Python-Odds-and-Ends/blob/main/Date_Range_DataFrame.ipynb) - use Pandas to create a DataFrame that contains a full range of dates.
...
* [Python File Mover](https://github.com/DataBaeDev/Python-Odds-and-Ends/blob/main/Python_File_Mover.ipynb) - Move a specific file type from one folder to another and append a timestamp to the file name.
